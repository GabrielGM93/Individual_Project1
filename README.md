...
You can click the [link](https://proyecto-individual1.onrender.com/docs) to access the developed API, consider that when setting the platform parameter, place only use the first letter of the platform, Amazon = "a", Netflix ="n", Hulu="h", Disney= "d" and the parameters for duration_type are "min" or "season"
